...
vType:any = ['Stop vehicle','LOLOLOL','Wheelie'];  
vNumber:number = 0;
  ...
  // method to find a vehicle to tow //TOWHERE
  findVehicleToTow(truckFun:Truck): void {
    inquirer
      .prompt([
        {
          type: 'list',
        ...
        if (answers.action === 'Print details') {
          ...
          for (let i = 0; i < this.vehicles.length; i++) {
            if (this.vehicles[i].vin === this.selectedVehicleVin && this.vehicles[i] instanceof Motorbike) {
              let wheelieGo =  this.vehicles[i] as Motorbike;
              wheelieGo.wheelie();//HERE 
            }
            else{
               console.log('Thats not Motorbike!')
              };
          }
        }
          ...
          if (selectedVehicle instanceof Truck) {
            ...
            console.log("Can't Tow! Not a Truck!");
            this.exit = true; 
            this.performActions();
          }
